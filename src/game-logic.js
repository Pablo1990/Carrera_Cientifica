export const genders = ['mujer', 'hombre', 'persona no binaria'];
export const genderDescriptors = { mujer: 'una mujer', hombre: 'un hombre', 'persona no binaria': 'una persona no binaria' };
